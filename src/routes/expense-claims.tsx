...
function BrandedHero() {
  return (
    <section className="travel-hero relative overflow-hidden rounded-2xl border border-border/60 shadow-elev sm:rounded-[1.4rem]">
        ...
        <div className="flex min-w-0 max-w-2xl items-start gap-3 sm:gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-3 max-w-xl text-sm font-light leading-relaxed text-white/80 sm:text-base">
              Submit, track and manage employee reimbursements, approvals and finance processing.
            </p>
          </div>
        </div>
      </div>
